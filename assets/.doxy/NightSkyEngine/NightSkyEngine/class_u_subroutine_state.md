...
# Class USubroutineState



[**ClassList**](annotated.md) **>** [**USubroutineState**](class_u_subroutine_state.md)
...
| Type | Name |
| ---: | :--- |
|  FGameplayTag | [**SubroutineName**](#variable-subroutinename)  <br> |
...
```C++
inline virtual void USubroutineState::CallExec () override
```
...
------------------------------
The documentation for this class was generated from the following file `C:/Users/wistf/Unreal Projects/NightSkyEngine/Plugins/NightSkyEngine/Source/NightSkyEngine/Battle/Script/SubroutineState.h`
